    ...
    subMinistries: [
      {
        ...
        image: require("../../../assets/image/CouncilImg.png"),
        alt:"Taking care of the children",
        description:
        ...
        content: [
          {
            type: "text",
            value:
              "Lorem ipsum dolor sit amet consectetur. Vitae libero lectus massa morbi. Elementum sit lorem at facilisi condimentum pulvinar sed in placerat. Tempor quam sodales eleifend phasellus nibh est amet id mi. Egestas habitasse arcu tincidunt tincidunt ac vitae facilisis tempus fermentum. Placerat integer sed dictum suscipit platea.",
          },
          {
            type: "text",
            value:
              "Enim arcu adipiscing mi volutpat. Pharetra fringilla ultrices proin gravida mauris risus ultricies ultrices. Faucibus tempor consectetur egestas ultrices pellentesque suspendisse diam accumsan. Pellentesque mauris nunc eget quam massa. Ullamcorper luctus tempor varius diam velit vel. Mi in vitae enim cursus tellus.",
          },
          {
            type: "text",
            value:
